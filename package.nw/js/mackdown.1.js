...
function analysis() {
    ...
    document.getElementById('reduce-show').innerHTML = parser.makeHtml(reduce_input);
    record_input = document.getElementById('record-edit').value;
    document.getElementById('record-show').innerHTML = parser.makeHtml(record_input);
    review_input = document.getElementById('review-edit').value;
    document.getElementById('review-show').innerHTML = parser.makeHtml(review_input);
